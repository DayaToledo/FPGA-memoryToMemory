...
io.on('connection', socket => {
  ...
  socket.on('disconnect', () => {
    let roomNameDisconnected;
    let userNameDisconnected;
    qntdSockets--;
    ...
    console.log("roomNameDisconnected:", roomNameDisconnected);
    console.log("userNameDisconnected:", userNameDisconnected);
    for (const username in rooms[roomNameDisconnected]) {
